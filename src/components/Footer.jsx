  ...
  const onSubmit = async (event) => {
    ...
    if (res.success) {
      <Alert color="success" onDismiss={() => alert("Alert dismissed!")}>
        <span className="font-medium">MAIL SENT SUCESSFULLY!</span> We will try
        to resolve your query as soon as possible. Thanks!
      </Alert>;
    }
  };
    ...
    <footer className="mt-20 border-t py-10 border-neutral-700 mx-10">
      <div className="grid grid-cols-3 lg:grid-cols-4">
        ...
        <div className="flex max-w-md flex-col gap-4 lg:-ml-20 md:block">
          <h3 className="text-lg font-bold bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text">
            CONTACT US
          </h3>
          ...
          <Button
            type="submit"
            onClick={onSubmit}
            className="border-0 mt-3 bg-gradient-to-r from-orange-500 to-orange-800"
          >
            SEND MESSAGE
          </Button>
        </div>
